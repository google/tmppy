...
def list_expr_to_ir1(list_expr: Union[ir2.ListExpr, ir2.ListPatternExpr]):
    ...
    list_template_name = _ir1_to_ir0.list_template_name_for_type(
        _ir1_to_ir0.type_to_ir0(type_to_ir1(list_expr.elem_type)))
...
def list_concat_expr_to_ir1(expr: ir2.ListConcatExpr):
    ...
    elem_kind = _ir1_to_ir0.type_to_ir0(type_to_ir1(expr.expr_type.elem_type)).kind
