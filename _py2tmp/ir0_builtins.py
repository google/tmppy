...
def _template_template_arg_decl(name: str, *args: ir0.TemplateArgDecl):
...
class GlobalLiterals:
    ...
    FOLD_BOOLS_TO_TYPE = ir0.AtomicTypeLiteral.for_nonlocal_template(cpp_type='FoldBoolsToType',
                                                                     args=[_type_arg_decl(''),
                                                                           _template_template_arg_decl('',
                                                                                                       _type_arg_decl(''),
                                                                                                       _bool_arg_decl('')),
                                                                           _variadic_bool_arg_decl('')],
...
def _local_metafunction_call(template_var_name: str,
                             arg_decls: Sequence[ir0.TemplateArgDecl],
                             args: Sequence[ir0.Expr],
                             instantiation_might_trigger_static_asserts: bool,
                             member_name: str,
                             member_type: ir0.ExprType):
    return _metafunction_call(template_expr=ir0.AtomicTypeLiteral.for_local(template_var_name, ir0.TemplateType(args=arg_decls), is_variadic=False),
                              args=args,
                              instantiation_might_trigger_static_asserts=instantiation_might_trigger_static_asserts,
                              member_name=member_name,
                              member_type=member_type)
...
# };
_define_template_with_single_specialization(name='TransformBoolListToBoolList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            specialization_args=[_variadic_bool_arg_decl('bs'),
                                                                 _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            patterns=[_bool_list_of(ir0.VariadicTypeExpansion(_local_variadic_bool('bs'))),
                                                      ir0.AtomicTypeLiteral.for_local(cpp_type='F', expr_type=ir0.TemplateType([_bool_arg_decl('')]), is_variadic=False)],
                                            error_expr=_get_first_error(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                           arg_decls=[_bool_arg_decl('')],
                                                                                                                           args=[_local_variadic_bool('bs')],
                                                                                                                           instantiation_might_trigger_static_asserts=True,
                                                                                                                           member_name='error',
                                                                                                                           member_type=ir0.TypeType()))),
                                            type_expr=_bool_list_of(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                       arg_decls=[_bool_arg_decl('')],
                                                                                                                       args=[_local_variadic_bool('bs')],
                                                                                                                       instantiation_might_trigger_static_asserts=True,
                                                                                                                       member_name='value',
...
# };
_define_template_with_single_specialization(name='TransformBoolListToInt64List',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            specialization_args=[_variadic_bool_arg_decl('bs'),
                                                                 _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            ...
                                            error_expr=_get_first_error(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                           ...
                                                                                                                           member_name='error',
                                                                                                                           member_type=ir0.TypeType()))),
                                            type_expr=_int_list_of(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                      arg_decls=[_bool_arg_decl('')],
                                                                                                                      args=[_local_variadic_bool('bs')],
                                                                                                                      instantiation_might_trigger_static_asserts=True,
                                                                                                                      member_name='value',
...
# };
_define_template_with_single_specialization(name='TransformBoolListToTypeList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            specialization_args=[_variadic_bool_arg_decl('bs'),
                                                                 _template_template_arg_decl('F', _bool_arg_decl(''))],
                                            ...
                                            error_expr=_get_first_error(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                           ...
                                                                                                                           member_name='error',
                                                                                                                           member_type=ir0.TypeType()))),
                                            type_expr=_type_list_of(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                       arg_decls=[_bool_arg_decl('')],
                                                                                                                       args=[_local_variadic_bool('bs')],
                                                                                                                       instantiation_might_trigger_static_asserts=True,
                                                                                                                       member_name='type',
...
# };
_define_template_with_single_specialization(name='TransformInt64ListToBoolList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _int64_arg_decl(''))],
                                            specialization_args=[_variadic_int64_arg_decl('ns'),
                                                                 _template_template_arg_decl('F', _int64_arg_decl(''))],
                                            patterns=[_int_list_of(ir0.VariadicTypeExpansion(_local_variadic_int('ns'))),
                                                      ir0.AtomicTypeLiteral.for_local(cpp_type='F', expr_type=ir0.TemplateType([_int64_arg_decl('')]), is_variadic=False)],
                                            error_expr=_get_first_error(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                           arg_decls=[_int64_arg_decl('')],
                                                                                                                           args=[_local_variadic_int('ns')],
                                                                                                                           instantiation_might_trigger_static_asserts=True,
                                                                                                                           member_name='error',
                                                                                                                           member_type=ir0.TypeType()))),
                                            type_expr=_bool_list_of(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
...
# };
_define_template_with_single_specialization(name='TransformInt64ListToInt64List',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _int64_arg_decl(''))],
                                            specialization_args=[_variadic_int64_arg_decl('ns'),
                                                                 _template_template_arg_decl('F', _int64_arg_decl(''))],
...
# };
_define_template_with_single_specialization(name='TransformInt64ListToTypeList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _int64_arg_decl(''))],
                                            specialization_args=[_variadic_int64_arg_decl('ns'),
                                                                 _template_template_arg_decl('F', _int64_arg_decl(''))],
...
# };
_define_template_with_single_specialization(name='TransformTypeListToBoolList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _type_arg_decl(''))],
                                            specialization_args=[_variadic_type_arg_decl('Ts'),
                                                                 _template_template_arg_decl('F', _type_arg_decl(''))],
                                            patterns=[_type_list_of(ir0.VariadicTypeExpansion(_local_variadic_type('Ts'))),
                                                      ir0.AtomicTypeLiteral.for_local('F', expr_type=ir0.TemplateType([_type_arg_decl('')]), is_variadic=False)],
                                            error_expr=_get_first_error(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
                                                                                                                           arg_decls=[_type_arg_decl('')],
                                                                                                                           args=[_local_variadic_type('Ts')],
                                                                                                                           instantiation_might_trigger_static_asserts=True,
                                                                                                                           member_name='error',
                                                                                                                           member_type=ir0.TypeType()))),
                                            type_expr=_bool_list_of(ir0.VariadicTypeExpansion(_local_metafunction_call('F',
...
# };
_define_template_with_single_specialization(name='TransformTypeListToInt64List',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _type_arg_decl(''))],
                                            specialization_args=[_variadic_type_arg_decl('Ts'),
                                                                 _template_template_arg_decl('F', _type_arg_decl(''))],
...
# };
_define_template_with_single_specialization(name='TransformTypeListToTypeList',
                                            main_definition_args=[_type_arg_decl('L'),
                                                                  _template_template_arg_decl('F', _type_arg_decl(''))],
                                            specialization_args=[_variadic_type_arg_decl('Ts'),
                                                                 _template_template_arg_decl('F', _type_arg_decl(''))],
...
_define_template(name='FoldBoolsToType',
                 ...
                 main_definition=_specialization(args=[_type_arg_decl('Acc'),
                                                       _template_template_arg_decl('F', _type_arg_decl(''), _bool_arg_decl('')),
                                                       _variadic_bool_arg_decl('bs')],
                 ...
                 specializations=[_specialization(args=[_type_arg_decl('Acc'),
                                                  ...
                                                  patterns=[_local_type('Acc'),
                                                            ir0.AtomicTypeLiteral.for_local('F', ir0.TemplateType([_type_arg_decl(''), _bool_arg_decl('')]), is_variadic=False),
                                                            _local_bool('b'),
                                                            ir0.VariadicTypeExpansion(_local_variadic_bool('bs'))],
                                                  type_expr=_fold_bools_to_type(_local_metafunction_call('F',
                                                                                                         arg_decls=[_type_arg_decl(''), _bool_arg_decl('')],
...
_define_template(name='FoldInt64sToType',
                 result_element_name='type',
                 main_definition=_specialization(args=[_type_arg_decl('Acc'),
                                                       _template_template_arg_decl('F', _type_arg_decl(''), _int64_arg_decl('')),
                                                       _variadic_int64_arg_decl('ns')],
                                                 type_expr=_local_type('Acc')),
                 specializations=[_specialization(args=[_type_arg_decl('Acc'),
                                                        _template_template_arg_decl('F', _type_arg_decl(''), _int64_arg_decl('')),
                                                        ...
                                                        _variadic_int64_arg_decl('ns')],
                                                  patterns=[_local_type('Acc'),
                                                            ir0.AtomicTypeLiteral.for_local('F', ir0.TemplateType([_type_arg_decl(''), _int64_arg_decl('')]), is_variadic=False),
                                                            _local_int('n'),
                                                            ir0.VariadicTypeExpansion(_local_variadic_int('ns'))],
                                                  type_expr=_fold_int64s_to_type(_local_metafunction_call('F',
                                                                                                          arg_decls=[_type_arg_decl(''), _int64_arg_decl('')],
                                                                                                          args=[_local_type('Acc'),
                                                                                                                _local_int('n')],
                                                                                                          instantiation_might_trigger_static_asserts=True,
                                                                                                          member_name='type',
...
_define_template(name='FoldTypesToType',
                 result_element_name='type',
                 main_definition=_specialization(args=[_type_arg_decl('Acc'),
                                                       _template_template_arg_decl('F', _type_arg_decl(''), _type_arg_decl('')),
                                                       _variadic_type_arg_decl('Ts')],
                                                 type_expr=_local_type('Acc')),
                 specializations=[_specialization(args=[_type_arg_decl('Acc'),
                                                        _template_template_arg_decl('F', _type_arg_decl(''), _type_arg_decl('')),
                                                        ...
                                                        _variadic_type_arg_decl('Ts')],
                                                  patterns=[_local_type('Acc'),
                                                            ir0.AtomicTypeLiteral.for_local('F', ir0.TemplateType([_type_arg_decl(''), _type_arg_decl('')]), is_variadic=False),
                                                            _local_type('T'),
                                                            ir0.VariadicTypeExpansion(_local_variadic_type('Ts'))],
                                                  type_expr=_fold_types_to_type(_local_metafunction_call('F',
                                                                                                         arg_decls=[_type_arg_decl(''), _type_arg_decl('')],
                                                                                                         args=[_local_type('Acc'),
                                                                                                               _local_type('T')],
                                                                                                         instantiation_might_trigger_static_asserts=True,
                                                                                                         member_name='type',
