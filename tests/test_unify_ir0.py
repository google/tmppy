...
@pytest.mark.parametrize('expr_generator', [
    ...
    lambda: ir0.BoolBinaryOpExpr(literal(True), literal(False), op='or'),
...
@pytest.mark.parametrize('expr1,expr2', [
    ...
    (ir0.Int64BinaryOpExpr(literal(1), literal(2), op='+'),
     ir0.Int64BinaryOpExpr(literal(1), literal(2), op='-')),
    (ir0.BoolBinaryOpExpr(literal(True), literal(False), op='or'),
     ir0.BoolBinaryOpExpr(literal(True), literal(False), op='and')),
...
@pytest.mark.parametrize('expr1,expr2', [
    ...
    (ir0.BoolBinaryOpExpr(literal(True), literal(True), op='and'),
     ir0.BoolBinaryOpExpr(literal(False), literal(True), op='and')),
    (ir0.BoolBinaryOpExpr(literal(True), literal(True), op='and'),
     ir0.BoolBinaryOpExpr(literal(True), literal(False), op='and')),
