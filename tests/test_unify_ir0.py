...
from _py2tmp.ir0_optimization.unify_ir0 import UnificationResultKind
...
def unify(exprs: List[ir0.Expr],
    ...
    return unify_ir0.unify(exprs, dict(), patterns, expr_variables, pattern_variables, iter(identifier_generator_fun()), verbose=True)
